        ...
        <SectionWrapper id="resume">
            ...
            <div className="flex flex-col items-center gap-6 max-w-3xl mx-auto">
                <p className="text-lg text-gray-300 max-w-2xl">
                    Download my AI/ML engineering resume to see my complete experience, projects, and technical skills in detail.
                </p>

                <div className="flex flex-wrap gap-4">
                    <Button className="bg-blue-600 hover:bg-blue-500 text-white border-none shadow-[0_0_15px_rgba(37,99,235,0.5)]" asChild>
                        <Link href="/resume-ai.pdf" target="_blank" download>
